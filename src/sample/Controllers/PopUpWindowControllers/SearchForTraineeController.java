...
public class SearchForTraineeController extends Controller {
    ...
    protected void addingNotification(String email){
        ...
        String content ="<div><b> Hi, the trainer <strong style=\"color:blue;\">"+TrainerUsername+"</strong> has added you into his training group.<br> If you have any questions contact him here: <strong style=\"color:blue;\">"+TrainerEmail+"</strong></b><br></div>";
